...
//        if (StringUtils.isNotNull(role.getRoleId()) && role.isTeacher())
//        {
//            throw new BusinessException("不允许操作教师角色");
//        }
//        
//        if (StringUtils.isNotNull(role.getRoleId()) && role.isStudent())
//        {
//            throw new BusinessException("不允许操作学生角色");
//        }
    }
